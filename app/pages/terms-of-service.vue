...
<template>
  <div class="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white">
    ...
    <div class="relative overflow-hidden border-b border-[#6366f1]/20">
      <div class="absolute inset-0 bg-linear-to-br from-[#6366f1]/8 via-transparent to-[#8b5cf6]/5 dark:from-[#6366f1]/10 pointer-events-none"></div>
          ...
          <div class="space-y-10">
            ...
            >
              <div class="flex items-center gap-3 mb-5">
                <div class="h-px flex-1 bg-linear-to-r from-[#6366f1]/40 to-transparent"></div>
                <h2 class="text-xl font-bold whitespace-nowrap">
                  {{ section.title }}
                </h2>
                <div class="h-px flex-1 bg-linear-to-l from-[#6366f1]/40 to-transparent"></div>
              </div>
